...
def get_weights(config, scamp=False, save_to_file=None):
    ...
    # f = open("/home/haleyso/CNN_CGRU/extracted_for_scamp_noise_fine_tuned.txt", "w")
    
    # f = open("/home/haleyso/CNN_CGRU/cvpr_scamp_cam.txt", "w")
...
if __name__ == '__main__':
    ...
    parser.add_argument('-stf', '--save_to_file', default='/home/haleyso/PixelRNN/cam_noise_weights.txt', type=str, help='where to save to')
    ...
    get_weights(config, args.scamp, args.save_to_file)
